...
export function WhatsAppFloat({ message }: { message?: string }) {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.92 }}
      className="fixed bottom-6 right-6 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lift ring-4 ring-[#25D366]/20"
    >
