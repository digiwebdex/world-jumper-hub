...
export default function VisaServices() {
  usePageTitle(
    ...
    "Six end-to-end visa services for Bangladeshi travellers — visa consultancy, in-Bangladesh processing, cross-border filing, e-visa, document legalisation and 24-hour express consultation."
  );
  return (
    <SiteLayout>
      <PageHero
        ...
        title={<>Six visa services,<br /><em className="not-italic text-accent">one trusted desk</em>.</>}
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 md:px-10 md:py-28">
        <SectionHeading
          ...
          title="Pick the visa service that fits your journey."
        />
