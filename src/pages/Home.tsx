        ...
        {(() => {
          ...
          return (
            <>
              ...
              <div className="mx-auto mt-8 grid max-w-7xl gap-6 px-4 sm:px-6 md:mt-10 md:grid-cols-3 md:px-10">
                {groups.map(g => {
                  const GIcon = g.icon;
                  return (
                    <div key={g.title} className="rounded-2xl border border-border bg-card/70 p-5 backdrop-blur-sm">
                      <div className="flex items-center gap-2 font-display text-xs font-bold uppercase tracking-widest text-[color:var(--brand-blue-deep)]">
                        <GIcon className="h-4 w-4 text-[color:var(--brand-orange)]" />
                        {g.title}
                      </div>
